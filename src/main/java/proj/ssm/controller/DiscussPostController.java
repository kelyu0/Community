...
public class DiscussPostController implements SsmConstant {
    ...
    public String addDiscussPost(String title, String content) {
        ...
        if (user == null) {
            return SsmUtil.getJSONString(403, "你还没有登录哦!");
        }
        ...
        // 报错的情况,将来统一处理.
        return SsmUtil.getJSONString(0, "发布成功!");
    }
